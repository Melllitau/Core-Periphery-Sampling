...
DATASETS_DIR = os.path.join(BASE_DIR, "..", "..", "..", "..", "EDA-ESG-Reports", "Sampling-Method", "data", "bills")

ROUNDS = {
    "round_0_cps":    "assignment_bills_CPS.jsonl",
    "round_1_random": "assignment_bills_random1.jsonl",
    "round_2_random": "assignment_bills_random2.jsonl",
    "round_3_random": "assignment_bills_random3.jsonl",
}
...
def main():
    for round_name, jsonl_file in ROUNDS.items():
        ...
        jsonl_path = os.path.join(DATASETS_DIR, jsonl_file)
        ...
        for i in range(n):
            ...
            text = docs[i].get("summary", "") or docs[i].get("text", "")
            rows.append({
                "text": text,
                "topic": gt_topic,
