...
def generate_topic_lvl2(
    ...
    try:
        with open("prompt/example-taesa.md", "r", encoding="utf-8") as f:
            generation_prompt = generation_prompt.replace("<document-1>", f.read())
        with open("prompt/example-elawan.md", "r", encoding="utf-8") as f:
            generation_prompt = generation_prompt.replace("<document-2>", f.read())
        with open("prompt/example-copel.md", "r", encoding="utf-8") as f:
            generation_prompt = generation_prompt.replace("<document-3>", f.read())
    except FileNotFoundError as e:
        print(f"Warning: Example file not found: {e}")
